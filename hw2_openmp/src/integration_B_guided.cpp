...
int main(int argc, char* argv[]) {
    ...
    // guided scheduling: starts with large chunks and exponentially decreases
    // chunk size down to chunk_size as iterations are consumed.
    // Large initial chunks reduce scheduling overhead; small final chunks
    // fine-tune load balance at the end — a compromise between static and dynamic.
